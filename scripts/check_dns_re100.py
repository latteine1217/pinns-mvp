...
LOG_FILE = 'log/dns_re100_20251121_131320.log'
...
try:
    ...
    if match:
        ...
        # 預估完成時間
        start = datetime.strptime("2025-11-21 13:13:20", "%Y-%m-%d %H:%M:%S")
        ...
        # 檢查 v 速度（關鍵指標）
        v_check = [l for l in lines if 't=' in l and 'Balance' in l]
        if len(v_check) > 5:
            print(f"\n💡 提示: 等待 t>10 後檢查 v 速度是否持續非零")
