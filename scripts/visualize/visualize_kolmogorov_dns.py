...
def plot_statistics_summary(data, output_dir):
    ...
    im4 = ax4.contourf(X, Y, u_rms, levels=256, cmap='viridis')
    ax4.set_xlabel('x')
    ax4.set_ylabel('y')
    ax4.set_title("U' RMS")
    ...
    im5 = ax5.contourf(X, Y, v_rms, levels=256, cmap='viridis')
    ax5.set_xlabel('x')
    ax5.set_ylabel('y')
    ax5.set_title("V' RMS")
    ...
    im6 = ax6.contourf(X, Y, turbulence_intensity, levels=256, cmap='plasma')
    ax6.set_xlabel('x')
    ax6.set_ylabel('y')
